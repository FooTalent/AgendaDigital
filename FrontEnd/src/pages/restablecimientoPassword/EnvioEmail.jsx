...
const EnvioEmail = () => {
    ...
    axios.post('http://localhost:4001/api/admin/olvide-password', userRegistered)
                    ...
                    navigate('/landingpage'); //TODAVIA NO ESTA CREADA LA LANDING PERO LA IDEA ES QUE CUANDO SE ENVIE EL EMAIL REDIRIJA A LA LANDING                     
                })
                    .catch(err => {
            ...
            <div className='containerLogin'>                
                        <form onSubmit={envioEmail} className='formLogin'>
                            ...
                            <div className='parrafoResetPass' ><span>Ingresa tu correo electrónico y te enviaremos un código para restablecerla.</span></div>
                                ...
                                <input className='pButton' type="submit" value="Enviar"/>
                                </div>
